...
data3 = 
  ...
  rename(z4 = age)
fit = coxph(Surv(time, delta)~z1 + z2 + z3 + z4 + z1 * z4, data = data3)
summary(fit)
```

**Explain results here**. The relative risk of dying is 0.0005587 for a stage II patient of age 50 as compared to a stage I patient of the same age.