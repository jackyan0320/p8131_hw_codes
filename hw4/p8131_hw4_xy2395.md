...
The odds ratio between high and low levels of contact is 0.2524, so people with higher level of contact with others have greater satisfaction.

The odds ratio between the housing types apartment and tower block is -0.5009. The odds ration between house and tower block is -0.7362. This tells us that house residents have the lowest level of satisfaction and tower block residents have the highest level of satisfaction.

iv) Pearson residuals
---------------------

``` r
pihat_polr = predict(fit_polr, type = 'prob')
...
```
    ...
    ## 1     low tower_block  0.779395680 -0.6525282  5.3355171
    ## 2     low   apartment  7.068039536  0.6416625  4.8069069
    ## 3     low       house  0.003118786 -2.3185429 -0.6078448
    ## 4    high tower_block -3.163276234 -1.4579762  5.4944010
    ## 5    high   apartment -3.862125662 -5.6527771 -0.2808228
    ## 6    high       house  0.274381655 -1.9448050 -2.0335724
...
The largest Pearson residual is 7.068, corresponding to the response level 'low satisfaction' and covariate levels 'low contact' and 'apartment'.
